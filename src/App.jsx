...
import { WordTransition } from "./components/animation/WordTransition";
		...
		<AppContext.Provider value={{ state, dispatch }}>
			...
			<main>
				<BubblesAnimation className="fixed top-0 left-0 h-svh w-full">
					<div className="hidden md:flex text-[96px] absolute z-[1] top-[40%] -translate-y-1/2 w-full items-center justify-center">
